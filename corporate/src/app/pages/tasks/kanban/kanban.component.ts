...
import { TaskListModel } from 'src/app/store/Task/task_model';
...
export class KanbanComponent implements OnInit {
  ...
  submitted = false;
  unassignedTasks!: TaskListModel[];
  todoTasks!: TaskListModel[];
  inprogressTasks!: TaskListModel[];
  reviewsTasks!: TaskListModel[];
  completedTasks!: TaskListModel[];
  newTasks!: TaskListModel[];
  alltask?: any;
  searchTerm: any;
