...
export class LeadsComponent {
  ...
  constructor(private modalService: NgbModal, public service: PaginationService, private formBuilder: UntypedFormBuilder, private datePipe: DatePipe, private store: Store<{ data: RootReducerState }>, private offcanvasService: NgbOffcanvas) {
  }
