...
export class EchartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._StepLineChart('["--vz-primary", "--vz-info", "--vz-gray-300"]');
    this._LineYChart('["--vz-primary"]');
    this._BasicBarChart('["--vz-info"]');
    ...
    this._CandleStickChart('["--vz-primary", "--vz-success"]');
    this._GraphChart('["--vz-primary"]');
    this._TreemapChart('["--vz-primary", "--vz-info"]');
    this._sunburstChart('["--vz-priamry", "--vz-info"]');
    this._ParallelChart('["--vz-info"]');
