...
export class LineComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._zoomableTimeseriesChart('["--vz-info"]');
    this._lineWithDataLabelsChart('["--vz-primary", "--vz-info"]');
    this._dashedLineChart('["--vz-primary", "--vz-gray-300", "--vz-info"]');
    ...
    this._brushLineChart('["--vz-primary"]');
    this._brushAreaChart('["--vz-info"]');
    this._stepLineChart('["--vz-info"]');
    this._gradientChart('["--vz-info"]');
    this._missingDataChart('["--vz-primary", "--vz-gray-300", "--vz-info"]');
  }
