...
export class AreaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicAreaChart('["--vz-info"]');
    this._splineAreaChart('["--vz-primary", "--vz-info"]');
    this._datetimeXaxisChart('["--vz-info"]');
    this._nagativeValueChart('["--vz-primary", "--vz-info"]');
    this._githubmMonthAreaChart('["--vz-info"]');
    this._githubmYearAreaChart('["--vz-primary"]');
    this._stackedAreaChart('["--vz-primary", "--vz-info", "--vz-gray-300"]');
    this._irregularTimeseriesChart('["--vz-primary", "--vz-info", "--vz-gray-300"]');
