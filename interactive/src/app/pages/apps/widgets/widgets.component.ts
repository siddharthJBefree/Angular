...
export class WidgetsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicBarChart('["--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-primary", "--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-info"]');
    this._basicColumnChart('["--vz-primary", "--vz-gray-300"]');
    this._simpleDonutChart('["--vz-primary", "--vz-primary-rgb, 0.80", "--vz-primary-rgb, 0.6", "--vz-primary-rgb, 0.4"]');
    this._basicHeatmapChart('["--vz-success", "--vz-info", "--vz-primary", "--vz-warning", "--vz-secondary"]');
