...
export class WalletComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._marketGraphChart('["--vz-info"]');
  }
 ...
 */
 ...
 /**
  ...
  // Pagination
  changePage() {
    this.WalletList = this.service.changePage(Wallets)
  }

  // Sorting
  onSort(column: any) {
    this.WalletList = this.service.onSort(column, this.WalletList)
  }

    // Search
    performSearch() {
      this.searchResults = Wallets.filter((item: any) => {
        return (
