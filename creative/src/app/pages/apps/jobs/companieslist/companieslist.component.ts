  ...
  */
  ...
  followClick(ev: any) {
    if (this.followbtn == '1') {
      ...
      document.getElementById('togglefollow')?.classList.replace('btn-soft-primary', 'btn-primary')
    } else {
      this.followbtn = '1'
      this.followtxt = 'Follow'
      document.getElementById('togglefollow')?.classList.replace('btn-primary', 'btn-soft-primary')
    }
  }
