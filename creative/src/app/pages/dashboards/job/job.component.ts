...
export class JobComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._dashedLineChart('["--vz-info", "--vz-secondary", "--vz-success"]');

    // Fetch Data
    setTimeout(() => {
      this.recomendedjobs = Recommendedjob
      this.allRecommendedjobs = Recommendedjob
      this.candidatelist = jobcandidate;
      this.candidatedetail = jobcandidate[0]
      this.recomendedjobs = this.service.changePage(Recommendedjob)
...
*/
  ...
  performSearch(): void {
    ...
    this.recomendedjobs = this.service.changePage(this.searchResults)
  }
}
